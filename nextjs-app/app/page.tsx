      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
        <div className="container mx-auto px-4 h-16 flex items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl font-medium text-gray-900 dark:text-gray-100">Translator</h1>
          </div>
        </div>
      </header>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-800">
            <div className="relative">
              <TextArea id="source-text" value={sourceText} onChange={setSourceText} placeholder="Nhập văn bản" readOnly={isLoading} />
              {sourceText && (
                <button
                  onClick={() => {
                    setSourceText('');
            ...
            <div className="relative">
              <TextArea id="translation" value={translation} onChange={() => {}} readOnly placeholder="Bản dịch" />
